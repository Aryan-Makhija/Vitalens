...
export default function FeedbackReportPage() {
    ...
    // Handle initial state if data missing after loading finishes
    ...
    return (
        <div className="min-h-screen bg-[#F8F9F7] py-6 px-4 sm:py-10 sm:px-6 font-sans text-[#2D3331]">
            <div className="max-w-5xl mx-auto">
                ...
                {/* 1. TOP NAVIGATION & HEADER (Static - Always visible) */}
                <div className="mb-8 sm:mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6">
                    <div>
                        ...
                        <h1 className="text-xs font-bold uppercase tracking-[0.3em] text-[#8B7E66] mb-1">Analysis Status</h1>
                        <h2 className="text-2xl sm:text-4xl font-serif text-[#1A1F1E] tracking-tight">Weekly Progress Report</h2>
                    </div>

                    {/* Escalation Status Badge Skeleton / Content */}
                    <div className="flex items-center w-full sm:w-auto">
                        {isLoading ? (
                            <div className="w-full sm:w-36 h-10 bg-gray-200/60 rounded-xl animate-pulse" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div className="bg-white p-5 sm:p-6 rounded-2xl border border-[#E5E9E7] shadow-sm flex flex-col justify-between min-h-[140px]">
                        {isLoading ? (
                    ...
                    <div className={`p-5 sm:p-6 rounded-2xl border shadow-sm flex flex-col justify-between min-h-[140px] sm:col-span-2 lg:col-span-1 transition-all ${!isLoading && reportData?.redFlagDetected
                        ...
                        <div className="mt-4 pt-3 border-t border-gray-100/50 flex items-center gap-2 text-xs text-gray-500">
                            <ShieldAlert size={14} className={(!isLoading && reportData?.redFlagDetected) ? "text-rose-500" : "text-gray-400"} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
                    <div className="lg:col-span-2 space-y-6">
                                            ...
                                            <>
                                                {reportData?.concernComparison?.map((item, index) => (
                                                    <tr key={`concern-${index}`} className="hover:bg-gray-50/50 transition-colors text-sm">
                                                        ...
                                                        <td className="py-4 px-4 sm:px-6">
                                                            <span className={`inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider ${item.currentState === "improving" ? "text-emerald-600" : "text-gray-600"
                                                                }`}>
                        ...
                        <div className="bg-gradient-to-br from-[#2D3A36] via-[#24332E] to-[#1A2421] text-white p-6 sm:p-10 rounded-3xl shadow-xl relative overflow-hidden min-h-[160px]">
                        ...
                        <div className="bg-white p-5 sm:p-6 rounded-3xl border border-[#E5E9E7] shadow-sm">
                            ...
                            <div className="space-y-6">
                                <div className="border-b border-gray-50 pb-4">
                                    ...
                                    {isLoading ? (
                                        <div className="h-6 bg-gray-200 rounded w-2/3 animate-pulse mt-1" />
                                    ) : (
