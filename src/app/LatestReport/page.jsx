            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#DCE4E1] pb-4">
                    <div>
                        ...
                        <h2 className="text-3xl font-serif text-[#1A1F1E] tracking-tight">Your Latest Clinical Report</h2>
                    </div>
                    <div className="flex items-center gap-3 self-start sm:self-center">
                        <Link href="/HomePage" className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#4A675D] bg-white border border-[#DCE4E1] py-2.5 px-4 rounded shadow-sm hover:bg-gray-50 transition-all">
                                    ...
                                    <div className="bg-[#1A1F1E] text-white p-8 rounded-xl relative overflow-hidden shadow-lg">
                                        <div className="relative z-10 max-w-2xl space-y-3">
                                            ...
                                            <h4 className="text-2xl font-serif tracking-tight flex items-center gap-2 text-stone-100">
                                                <Calendar className="text-[#174032]" size={22} /> 7-Day Optimization Program
                                            </h4>
                        ...
                        <div className="lg:col-span-1 p-6 bg-[#FAFBFB] space-y-8 text-xs">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="space-y-2 pt-1">
                                    ...
                                    {/* <div className="flex justify-between border-b border-gray-100 pb-1">
                                        <span className="text-stone-500">Data Cycle</span>
                                        <span className="font-mono text-gray-700 font-bold">2.5-Flash</span>
                                    </div> */}
    ...
    <div className="min-h-screen bg-[#F4F6F5] flex items-center justify-center p-6 fixed inset-0 z-50">
        <div className="text-center max-w-sm w-full space-y-6">
            ...
            <div className="space-y-1">
                <h2 className="font-serif text-xl text-[#2D3331] font-medium tracking-tight">Fetching Your Latest Report</h2>
