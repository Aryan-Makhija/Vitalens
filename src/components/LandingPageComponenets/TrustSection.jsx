...
//     description: "Our AI models are built on established medical guidelines and continuously updated with the latest health research.",
//   },
//   {
//     icon: Lock,
//     title: "Bank-Level Security",
//     description: "End-to-end encryption, HIPAA compliance, and zero data sharing. Your health data is yours — always.",
//   },
//   {
//     icon: Award,
//     title: "98.5% Accuracy Rate",
//     description: "Our risk detection engine has been validated against clinical datasets with consistently high accuracy scores.",
//   },
//   {
//     icon: BookOpen,
//     title: "Transparent AI Logic",
//     description: "Every recommendation comes with clear reasoning. We show you why, not just what — so you always understand your results.",
//   },
// ];
...
//         >
//           <span className="text-sm font-semibold text-primary uppercase tracking-wider">Trust & Safety</span>
//           <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-5">
//             Built on <span className="text-gradient">Trust & Transparency</span>
//           </h2>
//           <p className="text-muted-foreground text-lg">
//             Your health data deserves the highest standards of protection and accuracy. Here's how we deliver both.
//           </p>
//         </motion.div>
