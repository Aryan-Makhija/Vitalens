...
//     return (
//         <section id="plans" className="py-24 md:py-32 bg-secondary/40 relative overflow-hidden">
//             <div className="absolute top-1/2 right-0 w-80 h-80 bg-warm opacity-20 blob animate-float" />
...
//                 >
//                     <span className="text-sm font-semibold text-primary uppercase tracking-wider">Weekly Plans</span>
//                     <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-5">
//                         Personalized <span className="text-gradient">Weekly Wellness</span>
//                     </h2>
//                     <p className="text-muted-foreground text-lg">
//                         AI-generated weekly plans that adapt to your progress, habits, and health goals.
//                     </p>
//                 </motion.div>
...
//                 >
//                     {/* Mock weekly plan card */}
//                     <div className="bg-card rounded-3xl border border-border/50 shadow-elevated overflow-hidden">
//                         {/* Header */}
//                         <div className="gradient-cta px-8 py-6">
//                             <div className="flex items-center justify-between">
//                                 <div>
//                                     <p className="text-primary-foreground/80 text-sm font-medium">Week of Feb 17</p>
//                                     <h3 className="text-primary-foreground font-display font-bold text-xl mt-1">Your Wellness Plan</h3>
//                                 </div>
//                                 <div className="flex items-center gap-2 bg-primary-foreground/20 rounded-full px-3 py-1.5">
//                                     <TrendingUp className="w-4 h-4 text-primary-foreground" />
//                                     <span className="text-primary-foreground text-sm font-semibold">72% Complete</span>
//                                 </div>
//                             </div>
//                         </div>

//                         {/* Day selector */}
//                         <div className="flex gap-1 px-6 py-4 border-b border-border/50">
//                             {days.map((day, i) => (
//                                 <button
//                                     key={day}
//                                     onClick={() => setActiveDay(i)}
//                                     className={`flex-1 py-2 rounded-lg text-xs font-semibold transition-all ${i === activeDay
...
//                                 >
//                                     <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${item.done ? "bg-primary" : "border-2 border-border"
//                                         }`}>
//                                         {item.done ? (
...
//                                         <p className={`font-medium text-sm ${item.done ? "text-muted-foreground line-through" : "text-foreground"}`}>
//                                             {item.label}
//                                         </p>
//                                         <p className="text-xs text-muted-foreground">{item.detail}</p>
//                                     </div>
//                                     <item.icon className="w-5 h-5 text-muted-foreground group-hover:text-primary transition-colors shrink-0" />
//                                 </motion.div>
//                             ))}
//                         </div>
//                     </div>
