...
// import { ArrowRight, Shield, Brain, Heart, Sparkles, ChevronDown } from "lucide-react";
...
//                     <span className="text-sm font-medium text-foreground">AI-Powered Health Intelligence</span>
//                 </motion.div>
...
//                 >
//                     Early detection through intelligent analysis. VitaLens turns your daily habits and inputs into
//                     personalized health insights, weekly plans, and actionable guidance — all powered by advanced AI.
//                 </motion.p>
...
//                     <Link href="/HomePage">
//                         <button className="gradient-cta text-primary-foreground px-8 py-4 rounded-xl text-base font-semibold hover:opacity-90 transition-all shadow-elevated flex items-center gap-2 group">
//                             Start Your Free Check-in
//                             <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//                         </button>
//                     </Link>
//                     <button className="px-8 py-4 rounded-xl text-base font-semibold text-foreground border border-border hover:bg-secondary transition-colors">
//                         See How It Works
//                     </button>
//                 </motion.div>
...
//                 >
//                     {[
//                         { icon: Brain, label: "AI-Driven Analysis" },
//                         { icon: Shield, label: "HIPAA Compliant" },
//                         { icon: Heart, label: "10K+ Users Trust Us" },
//                     ].map(({ icon: Icon, label }) => (
