...
// import { FileInput, Cpu, BarChart3, CalendarCheck } from "lucide-react";
// const steps = [
//   {
//     icon: FileInput,
//     step: "01",
//     title: "Complete Your Health Profile",
//     description: "Answer guided questions about your lifestyle, habits, symptoms, and medical history. Our adaptive forms make it quick and easy.",
//   },
//   {
//     icon: Cpu,
//     step: "02",
//     title: "AI Analyzes Your Data",
//     description: "Multiple AI layers process your inputs — identifying patterns, cross-referencing health indicators, and building your risk profile.",
//   },
//   {
//     icon: BarChart3,
//     step: "03",
//     title: "Receive Your Insights Report",
//     description: "Get a comprehensive, easy-to-read health report with risk levels, recommendations, and personalized action items.",
//   },
//   {
//     icon: CalendarCheck,
//     step: "04",
//     title: "Follow Your Weekly Plan",
//     description: "Receive a customized weekly wellness plan with daily goals, habit adjustments, and progress checkpoints to keep you on track.",
//   },
// ];
...
//   return (
//     <section id="how-it-works" className="py-24 md:py-32 bg-secondary/40 relative overflow-hidden">
//       {/* Decorative blobs */}
//       <div className="absolute top-0 right-0 w-96 h-96 bg-sage-light opacity-30 blob animate-blob-morph" />
//       <div className="absolute bottom-0 left-0 w-64 h-64 bg-teal-light opacity-20 blob-2 animate-float-slow" />
...
//             Your Health Journey in <span className="text-gradient">4 Simple Steps</span>
//           </h2>
//           <p className="text-muted-foreground text-lg">
//             From check-in to action plan — here's how VitaLens transforms your health data into meaningful guidance.
//           </p>
//         </motion.div>
...
//                 >
//                   {/* Step number */}
//                   <div className="text-7xl font-display font-bold text-primary/10 absolute -top-4 left-1/2 -translate-x-1/2">
//                     {step.step}
//                   </div>
...
//                       className="w-16 h-16 rounded-2xl gradient-cta flex items-center justify-center mx-auto mb-5 shadow-soft"
//                     >
...
//                   {/* Connector line */}
//                   {i < steps.length - 1 && (
//                     <div className="hidden lg:block absolute top-1/3 -right-4 w-8 border-t-2 border-dashed border-primary/20" />
//                   )}
//                 </motion.div>
//               );
//             };
